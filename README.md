...
A webhook has been added so that any changes pushed to the repository will trigger the pipeline in Jenkins. The public URL has been generated using Cloudflare